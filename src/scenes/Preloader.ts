...
export default class Preloader extends Phaser.Scene {
  ...
  preload() {
    ...
    //Load Bird
    this.load.atlas(
      TextureKeys.BlueBird,
      "character/bluebird.png",
      "character/bluebird.json"
    ),
      this.load.atlas(
        TextureKeys.RedBird,
        "character/redbird.png",
        "character/redbird.json"
      ),
      this.load.atlas(
        TextureKeys.YellowBird,
        "character/yellowbird.png",
        "character/yellowbird.json"
      );
  ...
  create() {
    this.anims.create({
      key: AnimationKeys.BlueBirdAnims,
      frames: [
        {
          key: TextureKeys.BlueBird,
          frame: "bluebird-downflap.png",
        },
        {
          key: TextureKeys.BlueBird,
          frame: "bluebird-midflap.png",
        },
        {
          key: TextureKeys.BlueBird,
          frame: "bluebird-upflap.png",
        },
      ],
      frameRate: 10,
      repeat: -1,
